...
@section('content_header')
    <h1><b>Devolución de venta: Folio #{{ $venta->referenceNumber }}</b></h1>
@stop

@section('content')
<div class="card shadow">
    <div class="card-body">
        <form id="formDevolucion" action="{{ route('ventas.devolucion.procesar', $venta->id) }}" method="POST">
            @csrf
                ...
                <div class="col-md-3">
                    <div class="card border-danger">
                        <div class="card-body">
                            ...
                            <h4 class="text-danger"><strong>${{ number_format($venta->amountTotal, 2) }}</strong></h4>

                            <button type="button" class="btn btn-danger mt-4 w-100" id="btnConfirmarDevolucion">
                                <i class="fas fa-check"></i> Confirmar Devolución
                            </button>

                            <a href="{{ route('ventas.detalles', $venta->id) }}" class="btn btn-secondary mt-2 w-100">
