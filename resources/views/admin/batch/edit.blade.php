                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="batch_number" id="batch_number" class="form-control"
                            value="{{ $batch->batch_number }}" required>
                    </div>
                    <div class="col-md-6">
                        ...
                        <select name="product_presentation_id" id="product_presentation_id" class="form-control form-select"
                            ...
                            @foreach ($products_presentation as $presentation)
                                <option value="{{ $presentation->id }}"
                                    {{ $presentation->id == $batch->product_presentation_id ? 'selected' : '' }}>
