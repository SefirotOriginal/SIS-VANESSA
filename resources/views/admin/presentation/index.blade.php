                            ...
                            @foreach ($presentations as $presentation)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endcan
                                        @can('presentation.destroy')
                                            <form action="{{ route('presentations.destroy', $presentation) }}" method="POST"
                                                class="d-inline" id="formEliminar{{ $presentation->id }}">
                                                @csrf
                                                @method('DELETE')
                                                <button type="button" class="btn btn-danger btn-sm"
                                                    onclick="confirmarEliminacion({{ $presentation->id }})">
