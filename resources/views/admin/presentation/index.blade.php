...
<div class="card shadow">
    <div class="card-body">
        <div class="row mt-4">
            <a href="{{route('presentations.create')}}" class="btn btn-primary mb-3">
                    ...
                    <tbody id="batchesTableBody">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('presentations.destroy', $presentation) }}" method="POST" class="d-inline" id="formEliminar{{ $presentation->id }}">
                                    @csrf
                                    @method('DELETE')
                                    <button type="button" class="btn btn-danger btn-sm" onclick="confirmarEliminacion({{ $presentation->id }})">
