    ...
    <div class="card shadow w-100">
        <div class="card-body">
            <div class="mb-3">
                ...
                <input type="text" name="nombre" id="nombre" class="form-control" value="Soporte" required>
            </div>
            <div class="mb-3">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="permisos" value="configuracion" id="perm_configuracion" checked>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="permisos" value="usuarios" id="perm_usuarios" checked>
            ...
            <div class="d-flex justify-content-between">
                ...
                <div>
                    <button onclick="alertaBorrar()" class="btn btn-danger me-2">
                        <i class="fas fa-trash-alt"></i> Eliminar
                    </button>
                    <button onclick="alertaConfirmar()" class="btn btn-success">
