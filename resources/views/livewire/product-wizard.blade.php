{{-- filepath: resources/views/livewire/product-wizard.blade.php --}}
<div>
    ...
    @if ($currentStep == 1)
        <div class="step-content">
            <h5 class="mb-3">Paso 1: Datos del Producto</h5>
            <div class="mb-3">
    ...
    @if ($currentStep == 2)
        <div class="step-content">
            <h5 class="mb-3">Paso 2: Presentación y Precios</h5>
            <div class="mb-3">
    ...
    @if ($currentStep == 3)
        <div class="step-content">
            <h5 class="mb-3">Paso 3: Lote y Stock</h5>
            <div class="mb-3">
    ...
    <div class="d-flex justify-content-between mt-4">
        @if ($currentStep > 1)
            <button wire:click="previousStep" type="button" class="btn btn-secondary">Anterior</button>
        @else
            <div></div> {{-- Placeholder para alinear el botón a la derecha --}}
        @endif

        @if ($currentStep < 3)
            <button wire:click="nextStep" type="button" class="btn btn-primary">Siguiente</button>
        @else
            <button wire:click="save" type="button" class="btn btn-success">Guardar Producto</button>
        @endif
    </div>
</div>
