                                    ...
                                    <td>
                                        ...
                                        @can('purchase.destroy')
                                            <form action="{{ route('purchases.destroy', $purchase->id) }}" method="POST"
                                                class="d-inline" id="formEliminar{{ $purchase->id }}">
                                                @csrf
                                                @method('DELETE')
                                                <button type="button" class="btn btn-danger btn-sm" title="Eliminar Compra"
                                                    onclick="confirmarEliminacion({{ $purchase->id }})">
